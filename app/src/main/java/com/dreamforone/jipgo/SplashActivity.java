...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("push",Common.getPref(this,"push",false)+"");
        if(!Common.getPref(this, "setting", "").equals("ok")) {
            Common.savePref(this,"push",true);
            Common.savePref(this,"sound","3");
            Common.savePref(this,"headup",true);
        }
    ...
    public void goHandler() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                if(Common.getPref(getApplicationContext(),"first",false)) {
                    startActivity(new Intent(getApplicationContext(), MainActivity.class));

                }else{
                    startActivity(new Intent(getApplicationContext(), FirstViewActivity.class));
                }
                finish();
